...
class AuditLog:
    ...
    def _create_schema(self, path: str) -> None:
        ...
        This store has NO column migration -- it is in stage 3b only
        because #270/#276 was in flight against it. Swallowed exactly as
        before. Nothing about what gets recorded is touched.
        """
        try:
            conn = sqlite3.connect(path)
            try:
