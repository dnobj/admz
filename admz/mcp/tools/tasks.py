...
drift_audit / survey) and trigger-based **detection** tasks (e.g. a setup
notice when a device returns factory-defaulted). Creating/managing tasks still uses the
...
TOOLS: List[Tool] = [
    Tool(
        ...
        description=(
            ...
            "a setup notice when it returns factory-defaulted). Use this for "
