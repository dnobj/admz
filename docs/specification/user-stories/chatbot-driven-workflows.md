...
**Acceptance criteria:** (built in #510 — [ADR-0071](../decisions/0071-a-task-raises-a-notice-the-console-delivers-it.md); browser checks in `tests/e2e/MANUAL_notices_tests.md`)
